# Generated by Django 2.2.16 on 2022-09-04 11:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('moderator', 'Moderator'), ('user', 'User')], default='user', max_length=9, verbose_name='Роль')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='Адрес e-mail')),
                ('confirmation_code', models.CharField(default='00000', max_length=5)),

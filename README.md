# yamdb_final ![YaMDb Status](https://github.com/Rengoky/yamdb_final/actions/workflows/yamdb_workflow.yaml/badge.svg)
...
```
git clone https://github.com/Rengoky/infra_sp2.git
```
